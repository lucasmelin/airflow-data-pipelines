...
raw_data_file = '/usr/local/airflow/data/science/01_raw/iris.csv'
test_data_file = '/usr/local/airflow/data/science/05_model_input/example_test_x.pkl'
train_data_file = '/usr/local/airflow/data/science/05_model_input/example_train_x.pkl'
